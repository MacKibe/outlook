...
var node = /** @class */ (function () {
    ...
    node.show_content_panel = function (selected) {
        // 
...
var branch = /** @class */ (function (_super) {
    ...
    branch.get_child_node = function (name) {
        ...
        //
        if (parent === null)
            throw new Error("Node named ".concat(name, " cannot be found"));
        //
    ...
    branch.prototype.get_html = function () {
        //
        //leaf html
        var branch_html = "\n\n                <div id=\"".concat(this.path, "\" class=\"folder\">\n                    <div class=\"header\">\n                        <button  \n                            onclick=\"branch.toggle('").concat(this.name, "')\"\n                            class=\"btn\">+</button>\n                        <div\n                            data-id=\"").concat(this.path, "\"\n                            onclick=\"node.select(this)\n                        >\n                            <img src=\"images/").concat(this.icon, "\"/>\n                            <span>").concat(this.name, "</span>\n                        </div>\n                    </div>\n                    <div class=\"children hide\">\n                        ").concat(this.get_children_html(), "\n                    </div>\n                </div>\n               ");
        return branch_html;
    };
    //
...
var browser = /** @class */ (function (_super) {
    ...
    browser.prototype.check = function () {
        ...
        if (selected_div === (undefined || null)) {
            // 
            //Alert the user 
            alert("Please select a ".concat(this.target));
            // 
            //Fail gracefully 
            return false;
        }
    ...
    browser.prototype.show_panels = function () {
        return __awaiter(this, void 0, void 0, function () {
            var Node, html, nav, logical_path_node, id, html_path_node, element;
            return __generator(this, function (_a) {
                ...
                nav.innerHTML = html;
                logical_path_node = this.open_initial_path();
                id = logical_path_node.path;
                html_path_node = this.get_element(id);
                element = html_path_node.querySelector("div[data-id='".concat(id, "']"));
                //
        ...
        while (Node !== null) {
            ...
            if (Node instanceof branch) {
                ...
                var element = this.document
                    .querySelector("#".concat(Node.path, ">.children"));
                // 
                //Unhide the element.
