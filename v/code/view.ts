...
export class view {
    ...
    */
    ...
    //Return the element that matches the given id
    get_envelop_element(id:string):HTMLElement{
        //
        //Define element variable for supporting identifiaction of the required
        //envelop
        ...
        //Try the normal id route
         if (element = this.document.getElementById(id)) {
             //
             const data_field:HTMLElement|null = element.closest('*[data-field]');
             //
        ...
        if (elements.length>0) {
            //
            const data_field:HTMLElement|null = elements[0].closest('*[data-field]');
            //
             if (data_field) return data_field;
        }    
        //
