...
export class file extends input{
    ...
    constructor(
        ...
        // 
        //The home for the click listener that allows us to browse the server 
        //remotely 
    ...
    public toggle_source(_evt:Event):void{
        ...
        // 
        //Unhide the selector 
        this.source_selector.hidden=false;
        // 
...
export class textarea extends input{
    // 
    // The native text area element
    public textarea: HTMLTextAreaElement;
    //
    constructor(anchor: HTMLElement) {
        super("text", anchor);
        //
        //Set the native text area element
