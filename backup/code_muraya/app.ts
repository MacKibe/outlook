...
export abstract class app extends outlook.page{
    ...
    constructor(
        ...
        //
        this.dbname = this.config.app_dbname;
        // 
    ...
    async initialize(): Promise<void>{
        ...
        //
        //If this user exists then use him/her to login
        if (user_str !== null) {
            //
    ...
    private get_role_id(ename: library.ename, dbase: schema.database): boolean {
        ...
        const f_cnames = cnames.filter(cname => {
            ...
            const test = col instanceof schema.foreign
                && col.ref.dbname === schema.entity.user.dbname
                && col.ref.ename === schema.entity.user.ename
            // 
            //
            return test;
        });
    ...
    async login(User?: outlook.user) {
        ...
        if (User === undefined) {
            ...
            //
            //The login was aborted. Sto this login process
    ...
    async change_subject(selector: HTMLSelectElement): Promise<void> {
        ...
        //
        // Get the dbname
        const dbname = this.config.app_dbname;
        //
