...
class config{
    ...
    public string $report = "/outlook/v0/code/report.html";
    //
    //This is the complete path for the login template
    public string $login= "/outlook/v0/code/login.html";
    //
    //The complete path of the welcome template 
    public string $welcome= "/outlook/v0/code/welcome.html";
    //
    ...
    //The crud's template
    public string $crud = "/outlook/v0/code/crud.html";
    // 
    //This is the general template for collecting simple user data.
    public string $general = "/outlook/v0/code/general.html";
    // 
